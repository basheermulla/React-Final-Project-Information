...
function AutoCompleteComp({ callbackLabelProductInput, callbackLabelCustomerInput, modelTarget, data }) {
        ...
        <>
            {
                modelTarget === 'products' ?
                    <Autocomplete
                        disablePortal
                        onChange={(e, value) => {
                            callbackLabelProductInput(value)
                        }}
                        defaultChecked={''}
                        options={data
                    ...
                    <Autocomplete
                        disablePortal
                        onChange={(e, value) => {
                            callbackLabelCustomerInput(value)
                        }}
                        defaultChecked={''}
